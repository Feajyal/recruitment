...
//  fenetre
//
//  Created by Winé Hugo on 06/07/2021.
//
...
class DiversViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        if !text.isEmpty{
            data=api.search(keywords: text, mediaType: "all")
        }
